          ...
          <li key={r.id}>
            ...
            >
              ...
              <div className="flex flex-col gap-1 p-5">
                <p className="font-semibold text-[17px] tracking-tight text-[#1d1d1f] leading-snug line-clamp-2">
                  {r.title}
                </p>
                {r.description ? (
                  <p className="mt-1 line-clamp-2 text-[13px] text-[#6e6e73]">{r.description}</p>
                ) : null}
